...
![Zone ShopLab étudiée — S09](../course-materials/diagrams/S09_flux.svg)
...
| --- | --- |
| Zone étudiée | Client → API → fichier/URL/commande bornée |
...
1. **Goal** — observer ou modifier uniquement l’état annoncé pour `cas locaux non destructifs`.
...
8. **Evidence to save** — allowlist + preuve de refus; UTC, commande, sortie minimale, conclusion et limite.
